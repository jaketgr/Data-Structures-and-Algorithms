...
/*****************************ISVALIDWORD**********************************/
    ...
    public void validWordTest1() {
        JKWordSearch game = new JKWordSearch();
...
/*************************GETSCOREFORWORDS*****************************/
    ...
    //Regular tests
    //First two assume that your getAllScorableWords is working. I'll also make
    //Some for those who don't have those working yet.
    @Test public void getScoreTest3() {
        JKWordSearch game = new JKWordSearch();
        game.loadLexicon("words.txt");
        SortedSet<String> words = game.getAllScorableWords(6);
        int expected = 5;
    ...
    @Test public void getScoreTest4() {
        JKWordSearch game = new JKWordSearch();
        game.loadLexicon("words.txt");
        SortedSet<String> words = game.getAllScorableWords(10); //Returns an empty list
        int expected = 0;
        Assert.assertEquals(expected, game.getScoreForWords(words, 10));
    }

    //Tests without using getAllScorableWords
